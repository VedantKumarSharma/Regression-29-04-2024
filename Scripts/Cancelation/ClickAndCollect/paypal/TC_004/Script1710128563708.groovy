...
WebUI.click(findTestObject('smoke Suit/OPCPage/OPCPage/clickAndCollect_OPC'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('smoke Suit/OPCPage/OPCPage/ClickNCollectionRadioButton_Checkout'), FailureHandling.OPTIONAL)
