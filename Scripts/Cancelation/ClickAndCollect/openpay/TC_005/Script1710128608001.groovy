...
'MKP \r\n'
WebUI.callTestCase(findTestCase('smoke suit/CommonMethods/SearchForAProduct_search'), [('searchTerm') : '1030397815'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.enhancedClick(findTestObject('smoke Suit/OPCPage/OPCPage/Final_comparar_OPC'))
