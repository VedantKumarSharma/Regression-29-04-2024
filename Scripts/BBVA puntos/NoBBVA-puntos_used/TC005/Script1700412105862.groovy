...
WebUI.scrollToElement(findTestObject('smoke Suit/OPCPage/Putos_card1_CardPopup_OPC'), 0)

WebUI.click(findTestObject('smoke Suit/OPCPage/Putos_card1_CardPopup_OPC'))
...
WebUI.click(findTestObject('smoke Suit/OPCPage/BBVAputos_CheckBox_OPC'))
