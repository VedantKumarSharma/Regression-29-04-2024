...
WebUI.verifyElementText(findTestObject('smoke Suit/ConfirmationPage/WithPuntos_Pagaste_un_total_de_header_confirmPage'), 'Pagaste un total de:')
...
WebUI.verifyElementText(findTestObject('smoke Suit/ConfirmationPage/WithPuntos_Detalle_de_puntos_BBVA_confirmPage'), 'Detalle de puntos BBVA')
...
WebUI.verifyElementPresent(findTestObject('smoke Suit/ConfirmationPage/Saldo_anterior_0_puntos_CP'), 0)

'verify 0 puntos used'
WebUI.verifyElementPresent(findTestObject('smoke Suit/ConfirmationPage/Monto_utilizado_0_puntos_CP'), 0)

'verify 0 puntos used'
WebUI.verifyElementPresent(findTestObject('smoke Suit/ConfirmationPage/Saldo_actual_0_puntos_CP'), 0)
