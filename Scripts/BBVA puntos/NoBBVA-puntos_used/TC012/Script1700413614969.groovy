...
WebUI.verifyElementPresent(findTestObject('smoke Suit/AccountManagement/PuntosHelp_PopUp_Header_AM'), 0)

WebUI.verifyElementPresent(findTestObject('smoke Suit/AccountManagement/PuntosIMG_PuntosHelpPopUp_AM'), 0)

WebUI.verifyElementPresent(findTestObject('smoke Suit/OPCPage/OPCPage/close_popup_OPC'), 0)
