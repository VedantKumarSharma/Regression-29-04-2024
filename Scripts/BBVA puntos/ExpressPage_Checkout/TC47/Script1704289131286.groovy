...
WebUI.click(findTestObject('smoke Suit/OPCPage/card2_OPC'))

WebUI.verifyElementNotPresent(findTestObject('smoke Suit/OPCPage/PuntosCard_yellowtext_CardPopUPcard2_OPC'), 0)
...
WebUI.verifyElementNotPresent(findTestObject('smoke Suit/OPCPage/UsePuntosCheckbox_OPC'), 0)
