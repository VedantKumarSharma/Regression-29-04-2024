...
WebUI.click(findTestObject('smoke Suit/OPCPage/OPCPage/DigitalWallet_radiobutton_OPC'))

WebUI.verifyElementNotPresent(findTestObject('smoke Suit/OPCPage/BBVAputos_CheckBox_OPC'), 0)
