...
WebUI.verifyElementNotPresent(findTestObject('smoke Suit/CartPage/PcServices_Product1_AddToWishlist_Cartpage'), 0)

WebUI.verifyElementNotPresent(findTestObject('smoke Suit/CartPage/PcServices_product1_ComprarAhora_CartPage'), 0)

WebUI.verifyElementNotPresent(findTestObject('smoke Suit/CartPage/Garantia_Product1_ComprarParaMesaDeRegalos_CartPage'), 0)
...
WebUI.verifyElementNotPresent(findTestObject('smoke Suit/OPCPage/PcServices_product1_ComprarAhora_OPCpage'), 0)

WebUI.verifyElementNotPresent(findTestObject('smoke Suit/OPCPage/OPCPage/Garantia_Product1_ComprarParaMesaDeRegalos_OPC'), 0)
