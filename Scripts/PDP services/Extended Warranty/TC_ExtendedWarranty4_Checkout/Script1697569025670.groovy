...
WebUI.click(findTestObject('smoke Suit/CartPage/product1_BuyNowButton_CartPage'))

WebUI.verifyElementPresent(findTestObject('smoke Suit/OPCPage/PcServices_DIV_OPCpage'), 0)

WebUI.verifyElementNotPresent(findTestObject('smoke Suit/OPCPage/Product1_name_OPC2'), 0)

WebUI.verifyElementNotPresent(findTestObject('smoke Suit/OPCPage/PcServices_Product1_AddToWishlist_OPCpage'), 0)

WebUI.click(findTestObject('smoke Suit/OPCPage/paymentMethod_change_OPC'), FailureHandling.OPTIONAL)

WebUI.verifyElementNotClickable(findTestObject('smoke Suit/OPCPage/paymentMethod_button2_OPC'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementNotClickable(findTestObject('smoke Suit/OPCPage/paymentMethod_button3_OPC'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('smoke Suit/ConfirmationPage/ComplementaryServices_ConfirmPage_IMG'), 0)
