...
WebUI.click(findTestObject('smoke Suit/PLPPage/product-3-DiscountPrice_PLP'))

WebUI.enhancedClick(findTestObject('smoke Suit/PDPPage/ComplementaryServices_Div_option1_RadioButton_PDP'), FailureHandling.STOP_ON_FAILURE)
