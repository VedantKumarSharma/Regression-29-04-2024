...
WebUI.click(findTestObject('smoke Suit/BYD/BYD_PDP/Siguiente_POPup_BYD_PDP'))

WebUI.click(findTestObject('smoke Suit/BYD/BYD_PDP/Siguiente_POPup_BYD_PDP'))

WebUI.verifyElementNotClickable(findTestObject('smoke Suit/BYD/BYD_PDP/Siguiente_POPup_BYD_PDP'))

WebUI.click(findTestObject('smoke Suit/BYD/BYD_PDP/Anterior_POPup_BYD_PDP'))
