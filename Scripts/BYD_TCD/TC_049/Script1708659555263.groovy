...
WebUI.verifyElementPresent(findTestObject('smoke Suit/BYD/Visita el Showroom/Mark_pink_Point_on_MAP_BYD_SR'), 0)

WebUI.enhancedClick(findTestObject('smoke Suit/BYD/Visita el Showroom/Ven_a_conocer_tu_próximo_auto_text_BYD_SR'), FailureHandling.STOP_ON_FAILURE)
