...
WebUI.mouseOver(findTestObject('smoke Suit/BYD/BYD_HP/Models_BYD_HP'))

WebUI.verifyElementVisible(findTestObject('smoke Suit/BYD/BYD_HP/Models_BYD_HP_Flyout'))
