...
a = WebUI.getText(findTestObject('smoke Suit/BYD/Visita el Showroom/ShowRoom1_BYD_SR'), FailureHandling.STOP_ON_FAILURE)

b = WebUI.getText(findTestObject('smoke Suit/BYD/Visita el Showroom/ShowRoom2_BYD_SR'), FailureHandling.STOP_ON_FAILURE)

c = WebUI.getText(findTestObject('smoke Suit/BYD/Visita el Showroom/ShowRoom3_BYD_SR'), FailureHandling.STOP_ON_FAILURE)
