...
WebUI.mouseOver(findTestObject('smoke Suit/BYD/BYD_HP/Conoce_BYD_HP'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('smoke Suit/BYD/BYD_HP/Conoce_BYD_HP_Flyout'))
