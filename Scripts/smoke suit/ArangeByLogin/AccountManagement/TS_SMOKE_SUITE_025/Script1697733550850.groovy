...
WebUI.click(findTestObject('smoke Suit/AccountManagement/ChangePassword_Account'))

WebUI.click(findTestObject('smoke Suit/AccountManagement/ContinueButton_Account'))

WebUI.verifyElementPresent(findTestObject('smoke Suit/AccountManagement/MailConfirmation_Account'), 0)
