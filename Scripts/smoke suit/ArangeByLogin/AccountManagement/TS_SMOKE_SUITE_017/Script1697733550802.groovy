...
boolean a = WebUI.getText(findTestObject('smoke Suit/HomePage/span_HolaUser_hp'), FailureHandling.OPTIONAL)
...
address = WebUI.getText(findTestObject('smoke Suit/AccountManagement/NOTselected_personal_ShippingAddress1_AM'), FailureHandling.STOP_ON_FAILURE)
