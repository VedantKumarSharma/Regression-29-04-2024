...
WebUI.callTestCase(findTestCase('smoke suit/CommonMethods/SearchForAProduct_search'), [('searchTerm') : GlobalVariable.jeans], 
...
WebUI.verifyElementPresent(findTestObject('smoke Suit/HomePage/LoginPage_hp'), 0)

WebUI.verifyElementPresent(findTestObject('smoke Suit/AccountManagement/CreateNewAccount_Login'), 0)
