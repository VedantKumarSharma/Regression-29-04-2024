...
WebUI.verifyElementPresent(findTestObject('smoke Suit/AccountManagement/firstName_update_accountManagement'), 0)

WebUI.waitForPageLoad(0)

Name = 'harish'

//WebUI.click(findTestObject('smoke Suit/AccountManagement/firstName_update_accountManagement'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('smoke Suit/HomePage/header_Hola_text_HP'), 'Hola ' + Name)
