...
WebUI.setText(findTestObject('smoke Suit/OPCPage/OPCPage/enterCardExpire_OPC'), '1225')

WebUI.setText(findTestObject('smoke Suit/OPCPage/OPCPage/enterCardCVV_OPC'), '805')
