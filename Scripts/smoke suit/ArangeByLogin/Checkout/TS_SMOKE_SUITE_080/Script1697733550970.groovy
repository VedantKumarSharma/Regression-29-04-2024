...
WebUI.click(findTestObject('smoke Suit/PLPPage/product1_PLP'))
...
j = WebUI.getText(findTestObject('smoke Suit/OPCPage/Page_/TotalPrice_opc'))

String j1 = j.replace('$', '').replace(',', '')

a = WebUI.getText(findTestObject('smoke Suit/OPCPage/OPCPage/coupon_pricevalue_OPC'))

String a1 = a.replace('$', '').replace(',', '')

WebUI.click(findTestObject('smoke Suit/OPCPage/OPCPage/coupon_button_OPC'))

WebUI.click(findTestObject('smoke Suit/OPCPage/OPCPage/couon1_utilize_OPC'))

b = WebUI.getText(findTestObject('smoke Suit/OPCPage/OPCPage/coupon_pricevalue_OPC'))
...
k = WebUI.getText(findTestObject('smoke Suit/OPCPage/Page_/TotalPrice_opc'))
