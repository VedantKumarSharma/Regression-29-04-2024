...
WebUI.click(findTestObject('smoke Suit/HomePage/bag_header_HP'), FailureHandling.OPTIONAL)

List<WebElement> listElement = WebUI.findWebElements(findTestObject('smoke Suit/CartPage/Product1_remove_cart'),2)
...
for (int i = 0; i < noOfProducts; i++) {
    ...
    WebUI.click(findTestObject('smoke Suit/CartPage/Product1_remove_cart'))
...
WebUI.click(findTestObject('smoke Suit/HomePage/Logo_hp'), FailureHandling.OPTIONAL)
