...
WebUI.click(findTestObject('smoke Suit/OPCPage/Payment_Method_Card_OPC'), FailureHandling.OPTIONAL)

'to set card as default card\r\n'
WebUI.click(findTestObject('smoke Suit/OPCPage/addnewcard_Popup_OPC'), FailureHandling.OPTIONAL)
...
WebUI.setText(findTestObject('smoke Suit/OPCPage/newCard_expireDATE_POPup_Addcard_OPC'), '12/24')

WebUI.setText(findTestObject('smoke Suit/OPCPage/OPCPage/enterCardCVV_OPC'), '123')

WebUI.click(findTestObject('smoke Suit/OPCPage/selectAddress_Card_create_popup'))
