...
WebUI.setText(findTestObject('smoke Suit/OPCPage/LADA_addAddress_opc (1)'), GlobalVariable.LADAaddAddress, FailureHandling.OPTIONAL)

WebUI.setText(findTestObject('smoke Suit/OPCPage/phone_addAddress_opc (1)'), GlobalVariable.phoneAddAddress, FailureHandling.OPTIONAL)
