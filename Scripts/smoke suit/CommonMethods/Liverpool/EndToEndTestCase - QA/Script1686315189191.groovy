...
WebUI.callTestCase(findTestCase('smoke suit/CommonMethods/clickIniciarSession_Header'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('smoke suit/CommonMethods/loginFromHomePage'), [('username') : 'UN85@digisprint.com', ('password') : 'Un85@12345'], 
...
not_run: WebUI.verifyElementPresent(findTestObject('smoke Suit/CLPPage/breadCrumb_clp'), 0)
...
WebUI.callTestCase(findTestCase('smoke suit/CommonMethods/SearchForAProduct_search'), [('searchTerm') : 'vaso'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('smoke Suit/OPCPage/OPCPage/deliveryAddressHeading_address_opc'), 0)

WebUI.verifyElementPresent(findTestObject('smoke Suit/OPCPage/OPCPage/label_Cambiar_Address_opc'), 0)

WebUI.verifyElementPresent(findTestObject('smoke Suit/OPCPage/OPCPage/Forma de Pago_payment_opc'), 0)

WebUI.verifyElementPresent(findTestObject('smoke Suit/OPCPage/paymentSection_payment_opc'), 0)

WebUI.verifyElementPresent(findTestObject('smoke Suit/OPCPage/OPCPage/label_Cambiar_payment_opc'), 0)

WebUI.verifyElementPresent(findTestObject('checkoutpage/productSection_opc'), 0)

WebUI.verifyElementPresent(findTestObject('smoke Suit/OPCPage/productImage_opc'), 0)
...
WebUI.verifyElementPresent(findTestObject('smoke Suit/OPCPage/promotionSection_opc'), 0)
...
WebUI.verifyElementPresent(findTestObject('smoke Suit/OPCPage/button_Cupones_opc'), 0)

WebUI.click(findTestObject('smoke Suit/OPCPage/OPCPage/label_Cambiar_payment_opc'))

WebUI.click(findTestObject('smoke Suit/OPCPage/button_Efectivo y Transferencias_payment_opc (1)'))
...
WebUI.click(findTestObject('smoke Suit/OPCPage/button_Finalizar compra_opc'))
