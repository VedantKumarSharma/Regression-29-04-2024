...
WebUI.callTestCase(findTestCase('smoke suit/CommonMethods/SearchForAProduct_search'), [('searchTerm') : '1031144554'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('smoke Suit/OPCPage/changeADDRESS_OPC'))

WebUI.click(findTestObject('smoke Suit/OPCPage/OPCPage/clickAndCollect_OPC'))

WebUI.verifyElementPresent(findTestObject('smoke Suit/OPCPage/SeleccionUNA_Tienda(CNC)_OPC'), 0)
