...
WebUI.callTestCase(findTestCase('smoke suit/CommonMethods/SearchForAProduct_search'), [('searchTerm') : '1028042856'], FailureHandling.STOP_ON_FAILURE)

a = WebUI.getText(findTestObject('smoke Suit/PDPPage/RegalosPromotionName1_PDP'))

WebUI.click(findTestObject('smoke Suit/PDPPage/Quantity_StickyBar_PDP'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('smoke Suit/PDPPage/Quantity_StickyBar_PDP'), '65')
...
WebUI.click(findTestObject('smoke Suit/OPCPage/promotionSection_opc'))
